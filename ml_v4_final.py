...
def load_data(file_path):
    ...
    try:
        ...
        expected_columns = ["Event_Listeners", "Key_Code_Conversion", "Data_Accumulation", 
...
def balance_dataset(X, y):
    ...
    print("Before SMOTE class distribution:", y.value_counts())
...
def train_model(X, y):
    ...
    model = RandomForestClassifier(random_state=42, class_weight={0: 1, 1: 5}, n_estimators=100)
...
def save_model(model, directory="Keylogger Model"):
    ...
    filename = f"keylogger_model_{timestamp}_v4.pkl"
...
if __name__ == "__main__":
    dataset_path = "Synthetic_Dataset\synthetic_keylogger_dataset_v3.csv"
